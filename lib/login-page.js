...
try{var r=await fetch('/secure-gate/auth/setup',{method:'POST',headers:{'Content-Type':'application/json','X-DSH-Locale':zh?'zh':'en'},body:JSON.stringify({username:document.getElementById('su').value,password:pw})});
...
try{var r=await fetch('/secure-gate/auth/login',{method:'POST',headers:{'Content-Type':'application/json','X-DSH-Locale':zh?'zh':'en'},body:JSON.stringify({username:document.getElementById('u').value,password:document.getElementById('p').value})});
...
try{var r=await fetch('/secure-gate/auth/mfa',{method:'POST',headers:{'Content-Type':'application/json','X-DSH-Locale':zh?'zh':'en'},body:JSON.stringify({code:document.getElementById('mc').value})});
